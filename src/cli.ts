...
import { cleanProject, type CleanPlan } from './commands/clean.js';
import { runDoctor, summarizeReport, type DoctorReport } from './commands/doctor.js';
...
function printCleanPlan(
  plan: CleanPlan,
  context: { dryRun: boolean; projectRoot: string }
): void {
